            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { 
                  ...
                  unit: '/month',
                  desc: 'Get started with 100 free images',
                  features: ['100 images included', 'All models access', '3 requests/min', 'Community support'],
                },
                { 
                  name: 'Pay As You Go', 
                  price: pricing.symbol + pricing.perImage.toString(), 
                  unit: '/image',
                  desc: 'Scale as you grow. No commitment.',
                  features: ['No minimum spend', 'All models access', '10 requests/min', 'Email support'],
                },
                { 
                  name: 'Pro', 
                  price: pricing.symbol + pricing.pro.toString(), 
                  unit: '/month',
                  desc: 'For teams and production apps',
                  features: ['1,250 images/month', '25% volume discount', '50 requests/min', 'Priority support'],
                  popular: true 
                },
              ].map((plan) => (
